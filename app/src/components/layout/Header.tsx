...
const radaLinks = [
  { path: '/rada1', label: 'Рада №1 (Зелене)', icon: Building2 },
  { path: '/rada2', label: 'Рада №2 (Сонячний)', icon: Building2 },
];
      ...
      <div className="bg-[#1e3a5f] text-white py-2">
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/admin/login" className="text-sm hover:text-[#e67e22] transition-colors flex items-center gap-1">
                  ...
                  >
                    {radaLinks.map((link) => (
                      <Link
                        key={link.path}
                        to={link.path}
                        onClick={() => setRadaDropdownOpen(false)}
